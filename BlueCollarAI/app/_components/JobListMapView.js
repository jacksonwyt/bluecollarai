import { View, Text, Animated, StyleSheet, TouchableOpacity, Dimensions, ActivityIndicator } from 'react-native';
...
export const JobListItem = ({ job, isSelected, onPress }) => {
  ...
  if (isThemeLoading) {
    return (
      <View style={basicStyles.listItemLoadingContainer}>
...
const JobListMapView = ({ jobs, selectedJob, onJobSelect }) => {
  ...
  if (isThemeLoading) {
    return (
      <View style={basicStyles.mapViewLoadingContainer}>
