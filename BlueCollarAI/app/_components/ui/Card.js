...
const Card = ({ 
  ...
  const getVariantStyle = () => {
    switch (variant) {
      case 'glass':
        return styles(theme).glassCard;
      case 'elevated':
        return styles(theme).elevatedCard;
      case 'outline':
        return styles(theme).outlineCard;
      case 'flat':
        return styles(theme).flatCard;
      default:
        return styles(theme).defaultCard;
    }
  };
  ...
  return (
    <WrapperComponent
      ...
      style={[
        ...
        getVariantStyle(),
        getShadowStyle(),
        noPadding ? styles(theme).noPadding : {},
        {
    ...
    >
      {gradient && variant !== 'outline' && variant !== 'glass' && LinearGradient ? (
        <LinearGradient
          ...
          style={[styles(theme).gradientContainer, noPadding ? styles(theme).noPadding : {}]}
        >
          <CardContent />
        </LinearGradient>
      ) : (
